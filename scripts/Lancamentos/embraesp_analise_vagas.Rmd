...
#            area_util*0.95/n_unidades < 35 ~ "Menos que 35m²",
#            area_util*0.95/n_unidades >= 35 ~ "Mais que 35m²") %>%
#            fct_rev())
...
plot_vagas_por_unidade_sp_vs_eetu <-
  ...
  labs(title = "Média de vagas por unidade",
       subtitle = "As vagas por unidade têm tendência de queda desde antes do PDE que se intensifica pós PDE",
       x = "", y = "",
       fill = "")
...
plot_eetu_media_unidades <-
  ...
  labs(
    title = "Número médio de unidades por empreendimento nos eixos",
    subtitle = "Número médio de unidades por empreendimento cresce nos eixos pós-PDE",
    x = "", y = "")
...
plot_eetu_unidades_por_area <-
  ...
  labs(
    title = "Número de unidades nos eixos por faixa de área útil",
    subtitle = "O crescimento unidades com menos de 35m² é intenso nos eixos",
    x = "", y = "", fill = "")
...
plot_eetu_dp_area <-
  ...
  theme_minimal(base_family = "lato", base_size = 20) +
  labs(title = "Desvio-padrão das metragens das unidades por empreendimento nos eixos",
       subtitle = "Aumento indica maiores diferenças de metragens das unidades por empreendimento",
       x = "", y = "")
...
plot_eetu_media_area <-
  ...
  theme_minimal(base_family = "lato", base_size = 20) +
  labs(title = "Número médio das áres úteis das unidades nos eixos",
       subtitle = "Queda indica menores tamanhos médios das unidades dos empreendimentos",
       x = "", y = "")
...
plot_eetu_vagas <-
  ...
  theme(legend.position = "bottom") +
  labs(
    title = "Número de vagas nos eixos",
    subtitle = "O total de vagas nos eixos cresce após o PDE, associado ao aumento de unidades produzidas",
    x = "", y = "", fill = "")
...
plot_eetu_media_vagas_por_unidade <-
  ...
  labs(title = "Média de vagas por unidade nos eixos",
       subtitle = "A média de vagas por unidade nos eixos tem tendência de queda desde antes do PDE e se intensifica pós PDE",
       x = "", y = "")
...
plot_eetu_cenarios <-
  ...
  labs(
    title = "Limite de vagas nos eixos - comparação regra atual e nova regra",
